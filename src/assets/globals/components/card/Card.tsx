...
const Card: React.FC<CardProps> = ({ data }) => {
  ...
  <div className="w-full max-w-full sm:max-w-[220px] md:max-w-[250px] lg:max-w-[260px]">
    <div className="bg-white shadow-md rounded-3xl dark:bg-gray-800 dark:border-gray-700 transition-transform duration-300 hover:scale-105 hover:shadow-xl h-[45vh]">
