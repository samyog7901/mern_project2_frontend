        ...
        <main id="featured-products" className="w-full bg-white py-12 md:py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              {/* Sidebar */}
              <aside className={`w-full lg:w-1/5 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm sticky top-24 overflow-y-auto h-[45vh] transition-all duration-200 ${sidebarOpen ? "block" : "hidden lg:block"}`}>
