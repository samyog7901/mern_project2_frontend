...
const Cart = () => {
  ...
  const totalItemInCarts = cartItems.reduce(
    (total, item) => item?.quantity + total,
    0
  );
  const totalPriceInCarts = cartItems.reduce(
        ...
        {cartItems.length !== 0 ? (
          <>
            <button
              ...
              className="bg-gray-300 p-1 ml-2 shadow-blue-300 hover:shadow-blue-500 shadow-xl transition-transform duration-300 hover:scale-105 top-30 left-5 fixed"
            >
              add more items
            </button>
          ...
          <div className="flex flex-col items-center gap-y-20">
            <h1 className="text-center text-3xl text-fuchsia-900 relative top-10 h-1">
              My Shopping Cart
            </h1>
            <p className="relative top-20 text-center text-fuchsia-900 ">
              your cart is currently empty.
            </p>
            <p
              onClick={handleRedirect}
              className="w-40 text-center hover:text-fuchsia-900 mb-2  hover:cursor-pointer transition-transform duration-300 hover:scale-105 mt-3"
            >
              Continue shopping
            </p>
          </div>
